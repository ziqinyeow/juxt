...
import { useSite, Site } from "./SiteSwitcher";
...
const navigation = {
  ...
  app: [
    { name: "Documentation", href: "/app/docs" },
    // {
    //   name: "API Reference",
    //   href: "/repo/docs/reference/command-line-reference",
    // },
    // { name: "FAQ", href: "/app/docs/faq" },
  ],
  sdk: [
    { name: "Documentation", href: "/sdk/docs" },
        ...
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="grid grid-cols-1 gap-8 xl:col-span-2">
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 md:gap-8">
              ...
              <div className="mt-12 md:!mt-0">
                <FooterHeader>SDK</FooterHeader>
                <ul role="list" className="mt-4 space-y-1.5 list-none ml-0">
                  {navigation.sdk.map((item) => (
                    <li key={item.name}>
                      <FooterLink href={item.href}>{item.name}</FooterLink>
                    </li>
                  ))}
        ...
        <div className="pt-8 mt-8 sm:flex sm:items-center sm:justify-between">
          <div>
            ...
            <p className="mt-4 text-xs text-gray-500 dark:text-[#888888]">
              &copy; {new Date().getFullYear()} RTM. All rights reserved.
            </p>
          </div>
        </div>
      </div>
